        ...
        <>
          ...
          >
            <div className="mobile-passes-container">
              ...
              {/* Mobile Ticket Component */}
              <div className="mobile-ticket-section">
                <div className="mobile-ticket-wrapper">
                  <div className="mobile-pass-card mobile-pass-card--featured" style={{ width: '100%', maxWidth: '100%' }}>
                    ...
                    <div className="mobile-pass-card-header">
                      ...
                      <div style={{
                        marginTop: '1.5rem',
                        marginBottom: '0.5rem',
                        fontFamily: 'Victory Striker, sans-serif',
                        fontSize: '2.5rem',
                        lineHeight: 1,
                        color: '#fff',
                        textShadow: '0 2px 10px rgba(255,0,0,0.5)'
                      }}>
                        {countdownText48hr}
                      </div>

                      <p className="mobile-pass-subprice">DROPPING SOON</p>
                    </div>
